...
#### Ход работы:
#### Создаем Cubit для перерисовывания и вычислений счетчика. Файл click_cubit.dart отвечает за значение счетчика, а click_state.dart отвечает за состояние счетчика.
![image](https://user-images.githubusercontent.com/95757935/206034660-cca8ef04-a3a8-430b-8cd8-2cc3dce39286.png)
